...
<h2 class="label feed-label">Activity Feed    </h2>
...
<a href="./user.php?id=' . $uid . '" class="icon-container ' . $badge . '"><img src="' . "https://mii-unsecure.ariankordi.net/miis/image.png?data=" . $mii . "&type=face&width=120&expression=" . $feeling . "" . '" class="icon"></a>


<p class="user-name"><a ' . $nickcss . '>' . $username . '</a></p>
