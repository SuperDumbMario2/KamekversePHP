...
})(window, document, 'script', '//web.archive.org/web/20160308073818/https://www.google-analytics.com/analytics.js', 'ga');
...
(function(a, b) {
	b.init || (b.init = a.Deferred(function() {
		...
		if (b.length) {
			...
			if (h.length) {
				var i = function(a) {
						...
						a > c || 1 > a || (b.find(".js-album-selector-page[data-page-number=" + a + "]").removeClass("none").siblings(".js-album-selector-page").addClass("none"), h.toggleClass("back-button-disabled", 1 === a), h.toggleClass("next-button-disabled", a === c), h.attr("data-current-page-number", a), h.find(".js-curent-page-number").text(a))
					},
					j = function(a) {
		...
		var e = a("#post-form");
		e.hasClass("for-identified-user") || (b.find(".js-cannnot-topic-post").removeClass("none"), b.find(".js-feeling-selector").addClass("none"), b.find(".js-topic-categories-container").addClass("none"),
			b.find(".js-post-form-spoiler").addClass("none"), b.find('input[type="text"],textarea').prop("readonly", !0)), b.toggleClass("folded")
		...
		function c(a, b) {
			...
			return function() {
				...
				for (var e = [], f = 0; a > f; f++) e = e.concat(d(b, c, f));
				return c++, e
			}
		}
	...
	}), b.GoogleAnalytics = {}, b.GoogleAnalytics.setCommonVars = function(b) {
		var c = a(document.body),
			d = c.attr("data-hashed-pid"),
			e = a(".body-content").attr("data-region") || c.attr("data-user-region") || "";
		if (b) {
			var f = b.pathname,
				g = f.match(new RegExp("^/titles/([0-9]+)/([0-9]+)")),
				h = g ? g[1] : "",
				i = g ? g[2] : "";
			ga("set", "dimension16", i), ga("set", "dimension17", h)
		}
		if (ga("set", "dimension7", e), ga("set", "dimension13", "PC"), d) {
			var j = c.attr("data-country") || "",
				k = c.attr("data-lang") || "",
				l = c.attr("data-user-region") || "",
				m = c.attr("data-age") || "",
				n = c.attr("data-gender") || "",
				o = c.attr("data-game-skill");
			o = "1" === o ? "beginner" : "2" === o ? "intermediate" : "3" === o ? "advanced" : "";
			var p = c.attr("data-follow-done");
			p = "1" === p ? "yes" : "0" === p ? "no" : "";
			var q = c.attr("data-post-done");
			q = "1" === q ? "yes" : "0" === q ? "no" : "", ga("set", "userId", d), ga("set", "dimension1", j), ga("set", "dimension2", k), ga("set", "dimension3", l), ga("set", "dimension4", m), ga("set", "dimension5", n), ga("set", "dimension6", o), ga("set", "dimension8", p), ga("set", "dimension9", q)
		}
	}, b.GoogleAnalytics.refleshLocation = function(a) {
		ga("set", "location", a.href)
	}, b.GoogleAnalytics.trackPageView = function(a) {
		b.GoogleAnalytics.refleshLocation(a), b.GoogleAnalytics.setCommonVars(a), ga("send", "pageview")
	}, b.GoogleAnalytics.trackError = function(a) {
		b.GoogleAnalytics.setCommonVars(), ga("send", "exception", {
			exDescription: a
		})
		...
		var f = a(".track-error");
		return f.length > 0 ? void b.GoogleAnalytics.trackError(f.attr("data-track-error")) : void b.GoogleAnalytics.trackPageView(d)
	}), a(document).on("olv:ajax:error", function(a, c, d, e) {
		e.status && b.GoogleAnalytics.trackError(c.error_code)
	}), window.onerror = function(a, c, d) {
		var e = c + ":" + d + " - " + a;
		b.GoogleAnalytics.trackError(e)
	}, b.init.done(function(a) {
		...
		a(document).on("olv:entryform:updatescreenshot", function(b) {
			...
			e.attr("data-post-content-type", "text"), setTimeout(function() {
				c(d)
			}, 0)
		...
		}), a(document).on("olv:entry:profile-post:set", function(a) {
			b.GoogleAnalytics.trackEvent("profilePost", "setProfilePost")
		}), a(document).on("olv:entry:profile-post:remove", function(a) {
